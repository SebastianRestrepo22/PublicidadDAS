        ...
        <>
            ...
            <section className="w-full bg-white-50 py-12 px-6 lg:px-20">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-4xl mx-auto">
                    <div className="bg-card p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-traslate-y-2 text-center group">
                        <div className="flex justify-center mb-6">
                            <div className="p-4 bg-primary/10 riunded-full text-primary group-hover:bg-primary group-hover:text-primary-foreground transition-colors duration-300">
